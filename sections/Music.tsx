          ...
          <div key={release.id} className="group cursor-pointer">
            <div className="relative aspect-square mb-6 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-6">
                <a href={release.links.spotify} className="p-3 bg-green-500 rounded-full hover:scale-110 transition-transform" target="_blank" rel="noopener noreferrer">
                ...
                <a href={release.links.apple} className="p-3 bg-white rounded-full hover:scale-110 transition-transform" target="_blank" rel="noopener noreferrer">
            ...
            <div className="space-y-1">
              ...
              {/* Mobile Only - Music Platform Links */}
              <div className="md:hidden flex gap-4 pt-4">
                ...
                <a 
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-200 text-black rounded transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
